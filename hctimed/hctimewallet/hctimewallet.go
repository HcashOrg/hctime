...
func (d *HctimeWallet) Lookup(tx chainhash.Hash) (*Result, error) {
...
func (d *HctimeWallet) Construct(merkleRoot [sha256.Size]byte) (*chainhash.Hash, error) {
...
func (d *HctimeWallet) Close() {
	d.conn.Close()
}

// New returns a HctimeWallet context.
func New(cert, host string, passphrase []byte) (*HctimeWallet, error) {
	d := &HctimeWallet{
