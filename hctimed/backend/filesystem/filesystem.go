...
import (
	...
	"github.com/HcashOrg/hctime/hctimed/hctimewallet"
...
type FileSystem struct {
	...
	wallet *hctimewallet.HctimeWallet // Wallet context.
...
func New(root, cert, host string, enableCollections bool, passphrase []byte) (*FileSystem, error) {
	...
	// Runtime bits
	hctimewallet.UseLogger(log)
	fs.wallet, err = hctimewallet.New(cert, host, passphrase)
	if err != nil {
		return nil, err
	}
